        ...
        <div>
            <div className="lg:grid lg:grid-cols-2 lg:gap-6 py-5  bg-slate-800">
                <div className="flex flex-col justify-center text-center lg:p-40 md:text-left">
                    <h2 className="uppercase lg:text-3xl font-semibold md:text-4xl pb-5 text-white text-2xl">DON'T BE SHY</h2>
                    ...
                    <div className='flex justify-between mt-10 lg:p-0 p-5'>
                        <div className='flex flex-col justify-start items-start'>
                            <p className='text-white'><svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-10 h-10 text-yellow-500">
