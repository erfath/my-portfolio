            ...
            <div className='grid lg:grid-cols-3 grid-cols-1 lg:px-0 px-3  gap-20'>
                <div class="card lg:w-96 bg-slate-800 text-secondary shadow-xl mb-10 zoomIn">
                    ...
                    <div class="card-body items-center text-center">
                        ...
                        <div class="card-actions">
                            <label htmlFor="PerformCampModal" class="btn font-bold px-10 bg-yellow-500 text-black hover:bg-slate-900 hover:text-white hover:border-yellow-500">Explore Now</label>
                        </div>
                        <PerformCampModal/>
                    </div>
                </div>
                <div class="card lg:w-96 bg-slate-800 text-secondary shadow-xl mb-10 zoomIn">
                    ...
                    <div class="card-body items-center text-center">
                        ...
                        <div class="card-actions">
                            <label htmlFor="AutoPartsModal" class="btn px-10 bg-yellow-500 text-black hover:bg-slate-900 hover:text-white hover:border-yellow-500 font-bold">Explore Now</label>
                        </div>
                        <AutoPartsModal/>
                    </div>
                </div>
                <div class="card lg:w-96 bg-slate-800 text-secondary shadow-xl mb-10 zoomIn">
                    ...
                    <div class="card-body items-center text-center">
                        ...
                        <div class="card-actions">
                            <label htmlFor="BikersWorldModal" class="btn px-10 bg-yellow-500 text-black hover:bg-slate-900 hover:text-white hover:border-yellow-500 font-bold">Explore Now</label>
                        </div>
                       <BikersWorldModal/>
                    </div>
                </div>
                <div class="card lg:w-96 bg-slate-800 text-secondary shadow-xl mb-10 zoomIn">
                    ...
                    <div class="card-body items-center text-center">
                        ...
                        <div class="card-actions">
                            <label htmlFor="my-modal-3" class="btn px-10 bg-yellow-500 text-black hover:bg-slate-900 hover:text-white hover:border-yellow-500 font-bold">Explore Now</label>
                        </div>
                       <LensKingModal/>
                    </div>                   
                </div>
